      ...
      <div className="grid grid-cols-3 gap-2.5">
        {LEVELS.map((level) => {
          ...
          return (
            ...
            >
              <input type="checkbox" name={name} value={level} checked={checked} onChange={() => toggle(level)} className="absolute inset-0 cursor-pointer appearance-none rounded-[inherit] opacity-0" />
